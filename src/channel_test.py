...
def test_channel_join_invalid_channel():
    ...
    with pytest.raises(InputError) as e:
        channel.channel_join(test_user1["token"],invalid_channel_id['channel_id'])
    list_result1 = channels.channels_list(test_user1['token'])
...
def test_channel_addowner_valid():
    ...
    test_channel_private = channels.channels_create(user_channel_creater['token'] ,'test_channel_id1', False)
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user1['u_id'])
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user2['u_id'])
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user3['u_id'])
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user1['u_id'])
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user2['u_id'])
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user3['u_id'])
    member1 = None
...
def channel_addowner_invalid_owner():
    ...
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
    with pytest.raises(InputError) as e:
        assert channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
...
def channel_addowner_invalid_owner_not_in_channel():
    ...
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
    with pytest.raises(AccessError) as e:
        assert channel.channel_addowner(invalid_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
...
def channel_addowner_invalid_owner_not_owner():
    ...
    test_channel_private = channels.channels_create(user_channel_creater['token'] ,'test_channel_id', False)
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
    channel.channel_invite(user_channel_creater['token'],test_channel_private['channel_id'], invalid_channel_creater['u_id'])
    with pytest.raises(AccessError) as e:
        assert channel.channel_addowner(invalid_channel_creater['token'],test_channel_private['channel_id'], test_user['u_id'])
...
def test_channel_removeowner_valid():
    ...
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user2['u_id'])
    channel.channel_addowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user3['u_id'])
    channel.channel_removeowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user1['u_id'])
    channel.channel_removeowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user2['u_id'])
    channel.channel_removeowner(user_channel_creater['token'],test_channel_private['channel_id'], test_user3['u_id'])
    member1 = None
    for member in check_members.owner_members:
        if member["u_id"] == test_user1["u_id"]:
            member1 = member            
...
def channel_removeowner_invalid_owner():
    ...
    channel.channel_invite(user_channel_creater['token'], test_channel_private['channel_id'], test_user['u_id'])
    with pytest.raises(InputError) as e:
        assert channel.channel_removeowner(user_channel_creater['token'],test_channel_private['channel_id'],test_user['u_id'])
